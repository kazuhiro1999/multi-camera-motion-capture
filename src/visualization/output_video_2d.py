...
video_path = "output/keito/synced_video/keito_cBL_60fps.mp4"
pkl_path = "output/keito/pose2d/pose2d_keito_cBL.pkl"
output_path = "output/keito/keito_cBL_landmarks.mp4"
...
print("Landmark overlay video has been saved to:", output_path)